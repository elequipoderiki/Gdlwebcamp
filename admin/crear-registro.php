...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Crear Registros de Usuario Manual
						          ...
						          <li class="col-md-4">
						            <div class="tabla-precio text-center">
						              ...
						              <div class="orden">
						                ...
						                <input type="number" min="0" class="form-control" id="pase_dia" size="3" name="boletos[un_dia][cantidad]" placeholder="0">
					                ...
					                ?>
					                  <div class="col-md-4"> 
					                    ...
					                    <?php foreach($evento_dia as $evento) { ?>
					                      <label>
					                        <input type="checkbox" class="minimal" name="registro_evento[]" id="<?php echo $evento['id'];?>" value="<?php echo $evento['id'];?>"><time><?php echo $evento['hora'];?> </time><?php echo $evento['nombre_evento'];?>
					                        <br>
