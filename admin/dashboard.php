...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	      ...
	      <div class="col-lg-3 col-xs-6">
	        <?php  
	        	$sql = "SELECT COUNT(pagado) AS pulseras FROM registrados WHERE regalo = 1 AND pagado = 1";
	        	$resultado = $conn->query($sql);
	      ...
	      <div class="col-lg-3 col-xs-6">
	        <?php  
	        	$sql = "SELECT COUNT(pagado) AS etiquetas FROM registrados WHERE pagado = 1 AND regalo = 2";
	        	$resultado = $conn->query($sql);
	        	$regalo = $resultado->fetch_assoc();
	        ?>
	        <!-- small box -->
	      ...
	      <div class="col-lg-3 col-xs-6">
	        <?php  
	        	$sql = "SELECT COUNT(pagado) AS plumas FROM registrados WHERE pagado = 1 AND regalo = 3 ";
	        	$resultado = $conn->query($sql);
	        	$regalo = $resultado->fetch_assoc();
	        ?>
	        <!-- small box -->
