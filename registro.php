     ...
     -->
      ...
      <div id="eventos" class="eventos clearfix">
        <h3>Elige tus talleres</h3>
          <div class="caja">
            <!-- ** NOTA **  el campo registro solo se habilita cuando se completa alguno de los  anteriores 
              (ante evento blur sobre el input boletos[])-->
            ...
            <?php
              ...
              while($eventos = $resultado->fetch_assoc()){
                ...
                $dia_semana = translate_days($dia_semana);
